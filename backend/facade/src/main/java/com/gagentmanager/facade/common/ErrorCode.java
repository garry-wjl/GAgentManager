...
public record ErrorCode(int code, String message) {
    ...
    public static final ErrorCode FILE_TYPE_NOT_ALLOWED = new ErrorCode(1026, "不支持的文件类型");
    public static final ErrorCode SHARE_EXPIRED = new ErrorCode(1027, "分享已过期");
    public static final ErrorCode SHARE_NOT_FOUND = new ErrorCode(1028, "分享不存在");
    public static final ErrorCode DEVICE_NOT_FOUND = new ErrorCode(1029, "设备不存在");
    public static final ErrorCode CANNOT_KICK_CURRENT_DEVICE = new ErrorCode(1030, "不能踢出当前设备");
    ...
    public static final ErrorCode AGENT_MODEL_NOT_BOUND = new ErrorCode(1111, "Agent未绑定模型，不可发布");
    public static final ErrorCode OPTIMISTIC_LOCK_FAILURE = new ErrorCode(1112, "数据已被他人修改，请刷新后重试");
    public static final ErrorCode AGENT_MODEL_ALREADY_BOUND = new ErrorCode(1113, "Agent已绑定模型，不可重复绑定");
    ...
    public static final ErrorCode WORKFLOW_NOT_PUBLISHED = new ErrorCode(1505, "工作流未发布，不可绑定");
