...
public class ChatSessionRepositoryImpl implements ChatSessionRepository {
    ...
    @Override
    public IPage<ChatSession> findByUserIdWithPage(IPage<ChatSession> page, Long userId) {
        Page<ChatSessionEntity> mpPage = new Page<>(page.getCurrent(), page.getSize());
        LambdaQueryWrapper<ChatSessionEntity> qw = new LambdaQueryWrapper<ChatSessionEntity>()
                .eq(ChatSessionEntity::getUserId, userId)
                .eq(ChatSessionEntity::getDeleted, false)
                .orderByDesc(ChatSessionEntity::getLastMessageTime);
        IPage<ChatSessionEntity> result = chatSessionMapper.selectPage(mpPage, qw);
